...
<html lang="en">
    ...
    <body>
        ...
        <form class="d-flex" role="search" method="GET">
            <input class="form-control me-2" type="search" placeholder="Buscar por nombre o tipo o numero identificador" name="search" aria-label="Search">
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<thead><tr><th scope="col">ID</th><th scope="col">Identificador</th><th scope="col">Imagen</th><th scope="col">Nombre</th><th scope="col">Tipo</th><th scope="col">Descripcion</th><th scope="col">Accion</th></tr></thead>';
